...
class GestionCookie():
    PathCache = 'special://userdata/addon_data/plugin.video.netflix'
...
class cConfig():
    ...
    # def __init__(self):
        ...
        # self.__sFileDB = os.path.join(self.__oCache,'netflix.db').decode('utf-8')
...
def WindowsBoxes(sTitle, sFileName, metaType, year=''):
    ...
    # Sinon on gere par netflix via la lib TMDB
    ...
    try:
        ...
        DIALOG.VSok("Veuillez vider le cache des metadonnees Parametre - outils - 'vider le cache de netflix'")
        pass
    ...
    # convertion de la dur�e en secondes -> heure:minutes
...
#            self.getControl(50).reset()
            ...
            listitems3 = []
            if 'guest_stars'in meta and meta['guest_stars']: # dans certains �pisodes
                #Decodage python 3
        ...
        def onClick(self, controlId):
            ...
            if controlId == 11:
                ...
                self.setProperty('netflix_menu', 'Person')
            ...
            # click pour recherche
                ...
                # Si lanc� depuis la page Home de Kodi, il faut d'abord en sortir pour lancer la recherche
