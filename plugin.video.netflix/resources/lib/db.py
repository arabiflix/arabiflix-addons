...
class cDb:
    ...
    if name == 'Master user':
        ...
        DB = 'special://home/userdata/profiles/' + name + '/addon_data/plugin.video.netflix/netflix.db'
    ...
    def get_watched(self, meta):
        ...
        try:
            ...
            # Gestion des homonymes films / s�ries
            # Si la cat est enregistr�e, on v�rifie si c'est la m�me
        ...
        if sql_delete:
            ...
            try:
                ...
                if not update and sSiteUrl and sMovieTitle:
                    # si pas trouv�, on essaie sans le titre, seulement l'URL
    ...
    def del_viewing(self, meta):
        ...
        try:
            ...
            # si pas trouv�, on essaie sans la cat, juste le titre
