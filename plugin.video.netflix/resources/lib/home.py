...
class cHome:
    ...
    def showContact(self):
            url = 'https://github.com/arabiflix/arabiflix-addons/issues'

            DIALOG = dialog()

            ret = DIALOG.VSselect(['https://github.com/arabiflix/arabiflix-addons/issues'], 'يمكنك التواصل مع مطور الاضافة على')
