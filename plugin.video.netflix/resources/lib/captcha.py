...
def Captcha_Get_Reponse(img, cookie):
    ...
    # PathCache = xbmc.translatePath(xbmcaddon.Addon("plugin.video.netflix").getAddonInfo("profile"))
    # filename  = os.path.join(PathCache, "Captcha.raw").decode("utf-8")
    filename = "special://home/userdata/addon_data/plugin.video.netflix/Captcha.raw"
