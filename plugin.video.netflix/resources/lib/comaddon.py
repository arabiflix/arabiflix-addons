...
class dialog():
    ...
    def VSerror(self, e):
        return self.DIALOG.notification('netflix', 'Erreur: ' + str(e), xbmcgui.NOTIFICATION_ERROR, 2000), VSlog('Erreur: ' + str(e))
...
class progress():
    ...
    def VScreate(self, title = 'netflix', desc = '', large=False):
