...
# netflix = xbmcaddon.Addon('plugin.video.netflix')
# sLibrary = VSPath(netflix.getAddonInfo("path")).decode("utf-8")
...
class cClear:
    ...
    def main(self, env):
        ...
        if (env == 'resolveurl'):
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/arabiflix/arabiflix-addons/master/plugin.video.netflix/changelog.txt'
                ...
                self.TextBoxes('netflix Changelog', sContent)
            except:
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    sUrl = 'https://api.github.com/repos/arabiflix/arabiflix-addons/commits'
                    oRequest = urllib2.Request(sUrl)
                    oResponse = urllib2.urlopen(oRequest)
            ...
            path = "special://home/addons/plugin.video.netflix"
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/Kodi-netflix/venom-xbmc-addons/master/plugin.video.netflix/soutient.txt'
                oRequest = urllib2.Request(sUrl)
                oResponse = urllib2.urlopen(oRequest)
                ...
                self.TextBoxes('netflix Soutient', sContent)
            except:
                self.DIALOG.VSerror("%s, %s" % (self.ADDON.VSlang(30205), sUrl))
            return
            ...
            if self.DIALOG.VSyesno(self.ADDON.VSlang(30456)):
                cached_Cache = "special://home/userdata/addon_data/plugin.video.netflix/video_cache.db"
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.netflix/netflix.db"
            # important seul xbmcvfs peux lire le special
            try:
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                ADDON = addon()
                data = None
                path = VSPath('special://home/addons/plugin.video.netflix/resources/sites.json')
                def __init__(self, *args, **kwargs):
                    xbmcgui.WindowXMLDialog.__init__(self)
                    pass
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.netflix/resources/art/sites/%s.png" % aPlugin[1]
            ...
            DB = "special://home/userdata/addon_data/plugin.video.netflix/netflix.db"
            if select >= 0:
                try:
                    if select == 0:
                        # sélection d'un fichier
                        new = self.DIALOG.VSbrowse(1, 'netflix', "files")
                        if new:
                            xbmcvfs.delete(DB)
                            xbmcvfs.copy(new, DB)
                        ...
                        new = self.DIALOG.VSbrowse(3, 'netflix', "files")
                        if new:
                            xbmcvfs.copy(DB, new + 'netflix.db')
                            self.DIALOG.VSinfo(self.ADDON.VSlang(30099))
                except:
