...
class cAbout:
    ...
    def getUpdate(self):
        ...
        if service_time:
            ...
            if time_now - time_service > time_sleep:
                ...
                sUrl = 'https://api.github.com/arabiflix/arabiflix-addons/releases/'
    ...
    def resultGit(self):
        try:
            sUrl = 'https://raw.githubusercontent.com/arabiflix/arabiflix-addons/master/sites.json'
            oRequestHandler = cRequestHandler(sUrl)
            result = oRequestHandler.request(jsonDecode=True)

            sUrl = 'https://raw.githubusercontent.com/arabiflix/arabiflix-addons/master/hosts.json'
            oRequestHandler = cRequestHandler(sUrl)
            result += oRequestHandler.request(jsonDecode=True)
            # filtre trash & _init
    ...
    def checkdownload(self):
        ...
        if dialogs.VSyesno(addons.VSlang(30456)):
            ...
            sUrl = 'https://api.github.com/repos/arabiflix/arabiflix-addons/compare/%s...%s' % (service_version, service_futur)
            # pour test
            # sUrl = 'https://api.github.com/repos/arabiflix/arabiflix-addons/compare/0.6.3...0.6.31'
            ...
            if result:
                ...
                for i in result['files']:
                    ...
                    if 'plugin.video.netflix' in i['filename']:
                ...
                listitem = xbmcgui.ListItem(label = 'netflix', label2 = sContent)
                icon = 'special://home/addons/plugin.video.netflix/resources/art/update.png'
