...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            self.__sMovieFolder = 'special://userdata/addon_data/plugin.video.netflix/Films'
        ...
        if not self.__sTVFolder:
            self.__sTVFolder = 'special://userdata/addon_data/plugin.video.netflix/Series'
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.netflix/?function=play&site=cHosterGui&sFileName='
    ...
    def getLibrary(self):
        # xbmc.executebuiltin("Container.Update(special://userdata/addon_data/plugin.video.netflix/)", True)
        # xbmc.executebuiltin('ActivateWindow(Videos,"special://userdata/addon_data/plugin.video.netflix/")', True)
        oGui = cGui()
        path = 'special://userdata/addon_data/plugin.video.netflix/'
